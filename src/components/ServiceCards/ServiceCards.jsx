...
const ServiceCards = () => {
  ...
  return (
    ...
    >
      <div
        className="p-6 md:p-10 lg:p-14  bg-opacity-90 rounded-xl shadow-2xl max-w-7xl mx-auto transition-transform duration-300"
    ...
    ${
      isDarkEnabled
        ? "bg-[#0e1a49] text-white border-gray-600 focus:ring-gray-400"
