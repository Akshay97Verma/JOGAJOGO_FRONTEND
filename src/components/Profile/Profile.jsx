...
import { userSignout } from "../../redux/slice/authSlice";
...
const Profile = () => {
  ...
  return (
    <div
      className="relative flex items-center justify-center min-h-screen overflow-hidden bg-gray-100"
    >
      <img
        src={bgPic}
        alt="Background"
      ...
      />
      <div
        className="relative p-8 bg-opacity-90 rounded-lg shadow-2xl w-full md:w-3/4 lg:w-2/3 mx-auto z-10"
